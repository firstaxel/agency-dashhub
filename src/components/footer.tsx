  ...
  return (
    <footer className="border-b pt-20 ">
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="grid gap-12 md:grid-cols-5 md:gap-0 lg:grid-cols-3">
        ...
        <div className="mt-5 pt-5 border-t w-full">
          <form className=" border-b pb-8 text-sm md:border-none w-full">
            <div className="space-y-4 w-full">
              ...
              <div className="flex gap-2 items-center w-full ">
                <Input
                  ...
                  containerClassName="h-14  w-full  rounded-full"
                  className="rounded-full text-base "
                />
                <Button className="h-14 rounded-2xl">Submit</Button>
              </div>
        ...
        <div className="mt-5 flex flex-wrap items-end justify-between gap-6 border-t py-6">
